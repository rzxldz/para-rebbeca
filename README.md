...
Este proyecto fue desarrollado como una exploración personal de desarrollo web interactivo.

El objetivo principal fue experimentar con la combinación de programación, diseño visual, animaciones, audio, interacción, narrativa digital y diseño responsive.

El proyecto busca demostrar cómo tecnologías web pueden combinarse para crear una experiencia digital más allá de una página web tradicional.
